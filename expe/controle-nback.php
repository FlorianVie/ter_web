...
<script>
    function saveData() {
        ...
        xhr.open('POST', 'write_data_control_nback.php'); // change 'write_data.php' to point to php script.
...
<script>
    ...
    var instruction_start = {
        ...
        pages: ["<h1>Tâche d'écoute</h1>",
            ...
            "<p>Avant de débuter l'écoute, vous effecturez une tâche 2-back similaire à la session d'entrainement.</p>" +
            "<p>A la fin de l'écoute, une deuxième tâche 2-back démarrera automatiquement.</p>",
    ...
    var instruction_retran = {
        ...
        "<p>Durant les phases de pause, vous pourrrez prendre des notes si vous le souhaitez et si vous en avez le besoin dans la zone prévue à cet effet. Il n'est pas nécessaire de retranscrire le discours.</p>" +
        ...
        "<p>Les notes qui vous prennez disparaissent durant la phase d'écoute et reviennent durant les pauses.</p>",
            ...
            "<p><textarea name='rep-instr' id='test-instr-box' cols='40' rows='10' style='font-family: sans-serif; font-size: 1em' ></textarea></p>" +
    ...
    var retranscription = {
        ...
        html: '<h1>Vos notes :</h1>' +
            '<p><textarea name="rep" id="test-resp-box" cols="80" rows="20" style="font-family: sans-serif; font-size: 1em"></textarea></p>',
        ...
        on_finish: function (data) {
            ...
            console.log("Retransc :", data.retransc);
        }
    }
