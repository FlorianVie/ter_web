...
jsPsych.plugins['survey-html-form'] = (function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        // add submit button
        html += '<input type="submit" id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form" style="visibility: hidden" value="' + trial.button_label + '"></input>';
