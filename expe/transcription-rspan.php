...
<script>
    function saveData() {
        ...
        xhr.open('POST', 'write_data_retransc_rspan.php'); // change 'write_data.php' to point to php script.
...
<script>
    ...
    var instruction_start = {
        ...
        pages: ["<h1>Tâche de retranscription</h1>",
            ...
            "<p>Avant de débuter la retranscription, vous effecturez une tâche Reading Span similaire à la session d'entrainement (les deux parties combinées).</p>" +
            "<p>A la fin de la retranscription, une deuxième tâche Reading Span démarrera automatiquement.</p>",
